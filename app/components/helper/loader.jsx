...
export default function Loader() {
  if (typeof document === 'undefined') return <div className="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-gray-900 bg-opacity-75 z-50">
